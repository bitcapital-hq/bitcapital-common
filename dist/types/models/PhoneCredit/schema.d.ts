...
export declare class PhoneCredit extends BaseModel implements PhoneCreditSchema {
    walletId?: string;
    providerCode: string;
    phoneNumber: string;
    phoneCode: string;
...
export declare class PhoneCreditDealers extends BaseModel implements PhoneCreditDealersSchema {
    dealers: [{
        name: string;
        code: string;
    }];
